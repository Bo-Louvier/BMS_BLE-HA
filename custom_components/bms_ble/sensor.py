...
from .const import (
    ...
    ATTR_CELL_VOLTAGES,
    ATTR_CHRG_CUR_LIMIT,
    ATTR_CHRG_VOLT_LIMIT,
    ATTR_CURRENT,
    ATTR_CYCLE_CAP,
    ATTR_CYCLES,
    ATTR_DELTA_VOLTAGE,
    ATTR_DESIGN_CAP,
    ATTR_DISCHRG_CUR_LIMIT,
    ATTR_DISCHRG_VOLT_LIMIT,
    ATTR_LQ,
    ATTR_MAX_VOLTAGE,
    ATTR_MIN_VOLTAGE,
    ATTR_POWER,
...
SENSOR_TYPES: Final[list[BmsEntityDescription]] = [
    ...
    BmsEntityDescription(
        ...
        native_unit_of_measurement="Ah",
        optional=True,
        translation_key=ATTR_RATED_CAP,
    ...
    BmsEntityDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        key=ATTR_CHRG_VOLT_LIMIT,
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        optional=True,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        translation_key=ATTR_CHRG_VOLT_LIMIT,
        value_fn=lambda data: data.get("chrg_voltage_limit"),
    ),
    BmsEntityDescription(
        device_class=SensorDeviceClass.CURRENT,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        key=ATTR_CHRG_CUR_LIMIT,
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        optional=True,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        translation_key=ATTR_CHRG_CUR_LIMIT,
        value_fn=lambda data: data.get("chrg_current_limit"),
    ),
    BmsEntityDescription(
        device_class=SensorDeviceClass.VOLTAGE,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        key=ATTR_DISCHRG_VOLT_LIMIT,
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        optional=True,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        translation_key=ATTR_DISCHRG_VOLT_LIMIT,
        value_fn=lambda data: data.get("dischrg_voltage_limit"),
    ),
    BmsEntityDescription(
        device_class=SensorDeviceClass.CURRENT,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        key=ATTR_DISCHRG_CUR_LIMIT,
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        optional=True,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        translation_key=ATTR_DISCHRG_CUR_LIMIT,
        value_fn=lambda data: data.get("dischrg_current_limit"),
    ),
    BmsEntityDescription(
