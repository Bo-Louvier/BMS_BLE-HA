...
ATTR_CHRG_CUR_LIMIT: Final = "chrg_current_limit"  # [A]
ATTR_CHRG_MOSFET: Final = "chrg_mosfet"  # [bool]
ATTR_CHRG_VOLT_LIMIT: Final = "chrg_voltage_limit"  # [V]
...
ATTR_DISCHRG_CUR_LIMIT: Final = "dischrg_current_limit"  # [A]
ATTR_DISCHRG_MOSFET: Final = "dischrg_mosfet"  # [bool]
ATTR_DISCHRG_VOLT_LIMIT: Final = "dischrg_voltage_limit"  # [V]
ATTR_FAN: Final = "fan"  # [bool]
...
ATTR_PRECHRG_MOSFET: Final = "precharge_mosfet"  # [bool]
ATTR_PROBLEM: Final = "problem"  # [bool]
ATTR_PROBLEM_CODE: Final = "problem_code"  # [str]
ATTR_RATED_CAP: Final = "rated_capacity"  # [Ah]
ATTR_RSSI: Final = "rssi"  # [dBm]
ATTR_RUNTIME: Final = "runtime"  # [s]
ATTR_TEMP_SENSORS: Final = "temperature_sensors"  # [°C]

BINARY_SENSORS: Final[int] = 8  # total number of binary sensors
LINK_SENSORS: Final[int] = 2  # total number of sensors for connection quality
OPT_SENSORS: Final[int] = 7  # total number of optional sensors (BmsEntityDescription)
SENSORS: Final[int] = 18  # total number of sensors
